...
def main() -> None:
    ...
    ap.add_argument("--row", required=True, help="JSON dict for a single row, e.g. '{\"x1\":0.1,\"x2\":-0.2}'")
    args = ap.parse_args()
    ...
    deliverables = Path(".meridian") / "deliverables"
    if deliverables.exists():
        print(f"NOTE: deliverables present at {deliverables.resolve()}")
